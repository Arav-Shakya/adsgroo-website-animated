      ...
      <div className="flex justify-between items-center md:border border-white/15 md:p-2.5 rounded-xl max-w-2xl mx-auto md:backdrop-blur">
        ...
        <div className="hidden md:block">
          <nav className="flex gap-8 text-sm">
            <a href="#clients" className="text-white/70 hover:text-white transition">Clients</a>
            ...
            <a href="#consultation" className="text-white/70 hover:text-white transition">Consultation</a>
          </nav>
        </div>
